                  ...
                  children: <Widget>[
                    Row(
                      ...
                      style: Theme.of(context)
                        ...
                        if (chatHistory.buyer!.applicationStatus == PsConst.ONE &&
                            chatHistory.buyer!.applyTo == PsConst.ONE &&
                            chatHistory.buyer!.userType == PsConst.ONE)
                          Container(
                            margin:
                    ...
                    //   )
                        ...
                        //  padding: const EdgeInsets.all(PsDimens.space4),
                          decoration: BoxDecoration(
                            color: PsColors.mainColor,//PsColors.primary500,
