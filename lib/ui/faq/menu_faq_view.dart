...
class MenuFAQView extends StatefulWidget {
  const MenuFAQView({Key? key, required this.animationController})
      : super(key: key);
  final AnimationController? animationController;
  @override
  _MenuFAQViewState createState() => _MenuFAQViewState();
}

class _MenuFAQViewState extends State<MenuFAQView> {
