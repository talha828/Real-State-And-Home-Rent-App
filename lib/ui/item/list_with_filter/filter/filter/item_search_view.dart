  ...
  Widget build(BuildContext context) {
    ...
    final Widget _searchButtonWidget = PSButtonWidget(
        ...
        onPressed: () {
          ...
          if (_searchProductProvider.isSoldOut != null) {
          _searchProductProvider.productParameterHolder.isSoldOut =
              _searchProductProvider.isSoldOut;
          }
          ...
          if (_searchProductProvider.locationId.isNotEmpty) {
            _searchProductProvider.productParameterHolder.itemLocationCityId =
          ...
          IconButton(
              ...
              onPressed: () {
                ...
                _searchProductProvider.selectedLocationTownshipName = Utils.getString(
                                    context, 'product_list__category_all');
                _searchProductProvider.productParameterHolder.postedById =  '';
                _searchProductProvider.selectedPostedName = Utils.getString(
                                    context, 'home_search__not_set');
                _searchProductProvider.productParameterHolder.amenityId = '';
                _searchProductProvider.selectedAmenityName = Utils.getString(
                                    context, 'home_search__not_set');
                _searchProductProvider.productParameterHolder.isSoldOut = '';
                _searchProductProvider.selectedSoldOutName = Utils.getString(
                                    context, 'home_search__not_set');
                        ...
                        PsDropdownBaseWidget(
                          ...
                          onTap: () async {
                            ...
                            if (locationResult != null &&
                                locationResult is ItemLocationCity) {
                      ...
                      onTap: () async {
                        ...
                        final SearchProductProvider provider =
                            Provider.of<SearchProductProvider>(
                                context,
                                listen: false);
                          final dynamic postedResult =
                              await Navigator.pushNamed(context,
                                  RoutePaths.searchPostType);

                          if (postedResult != null &&
                              postedResult is PostType) {
                            provider.postedById =
                                postedResult.id!;
                      ...
                      onTap: () async {
                        ...
                        final SearchProductProvider provider =
                            Provider.of<SearchProductProvider>(
                                context,
                                listen: false);
                          final dynamic soldOutResult =
                              await Navigator.pushNamed(context,
                                  RoutePaths.searchSoldOut);

                          if (soldOutResult != null &&
                              soldOutResult is Product) {
                            provider.isSoldOut =
                                soldOutResult.isSoldOut!;

                            provider.selectedSoldOutName =
                                soldOutResult.isSoldOut == PsConst.ZERO ? 'Not Sold Yet' : 'Sold Out';
                          }
                        }),  
